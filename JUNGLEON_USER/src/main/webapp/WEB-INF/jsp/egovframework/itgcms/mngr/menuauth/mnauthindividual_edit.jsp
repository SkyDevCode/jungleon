						...
						<div id="authLayer" style="height:100%; min-height:470px;">
							<div class="col-md-12" id="registLayer">
								<form name="form1" id="form1" method="post" onsubmit="fn_save(); return false;">
									<input type="hidden" name="menuAuthIdx" id="menuAuthIdx" value="<c:out value='${mngrAuth.menuAuthIdx}'/>"/>
									...
									<table class="table table-bordered tp2">
										...
										<tbody>
											<tr>
												<th class="t">관리자명</th>
												<td>${mngrInfo.mngName}
													<input type="hidden" name="mngId" id="mngId" title="관리자아이디" value="${mngrInfo.mngId}" />
													<input type="hidden" name="menuAuthName" id="menuAuthName" title="메뉴권한명" value="${mngrInfo.mngId}" />
												</td>
											</tr>
											<tr>
												<th class="t">관리사이트</th>
	...
	function fn_save(){
		...
		if(Validator.validate(frm)){
			...
			if(confirm("수정 하시겠습니까?")){
 				frm.action="/_mngr_/menuauth/mnauthindiv_edit_proc.do";
				frm.submit();
			}
		}
	}
