							...
							<div class="row margin-bottom">
								<div class="col-sm-8 form-inline tp2">
									...
									<select name="schFld" id="schFld" class="form-control input-sm">
										...
										<option value="3" ${ufn:selected(searchVO.schFld, '3') }>닉네임</option>
									</select>
...
<%-- 												<td class="tb_left bg_id"><a href="#none" onclick="fn_goView('<c:out value="${result.id }" />'); return false;"><c:out value="${result.id}" /></a></td> --%>
												...
												<td class="bg_nickname tac"><c:out value="${ufn:isNull(result.nickName, '(내용없음)')}" /></td>
												<td class="tac"><c:out value="${result.sex}" /></td>
...
<div class="modal" id="typeForAccess">
 ...
 <script type="text/javascript">
	...
	function fn_memberExcel() {
		$("#schExcel").val("Y");
		//document.listForm.action = "mngrMemberExcelDownload.do";
		document.listForm.action = "/excel/mngrMemberExcelDown.do";
		document.listForm.submit();
	}
