		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		      	<div class="modalScr" style="">
		      		<h5 style="text-align:right; color:red;">※ 붉은색 : 실패로그</h5>
...
function fn_showLogList(id){
	$.ajax({
		...
		for(i = 0; i < data.result.length; i++){
			if(data.result[i].logType == '3') stylestr = " style='color:red'";
			else stylestr = "";
			str += "<tr>";
	        str += "<td"+stylestr+">"+data.result[i].logRegdt+"</td>";
	        str += "<td"+stylestr+">"+data.result[i].logIp+"</td>";
	        str += "<td"+stylestr+">"+data.result[i].logDevice+"</td>";
	        str += "<td"+stylestr+">"+data.result[i].logOs+"</td>";
	        str += "<td"+stylestr+">"+data.result[i].logBrowser+"</td>";
	        str += "</tr>";
      }
