...
/*                                     $.ajax({
                                        ...
                                        success: function (res) {
                                            if (res.result == '1') {
                                            	...
                                            	${objectId}_dialog.alert("파일삭제 중 오류가 발생하였습니다.");
                                                return;
                                            }
                                        }
                                    }); */
                        ...
                        case "arrowup":
                        	...
                        	//${objectId}_dialog.alert("location.href ="+ ${objectId}_SWAP_URL + "?mode=UP&schIdx="+file.fileIdx);
                        	//console.log("${objectId}_delIdxs.length : "+${objectId}_delIdxs.length);
                        	//console.log("${objectId}.uploadedFiles.length : "+${objectId}.uploadedFiles.length);
                        	//console.log("${objectId}_fileChange : "+${objectId}_fileChange);
                        	//console.log("arrowup change : "+(${objectId}_delIdxs.length + ${objectId}.uploadedFiles.length  > 0 && ${objectId}_fileChange));
