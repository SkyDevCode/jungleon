...
<c:if test="${boardconfigVO.bcRSS eq 'Y'}">
	function getRSS(){
		window.open("${ctx}/resource/templete/cms1/rss/${menuVO.menuCode}.do");
	}
</c:if>
		           	...
		           	<span>
			             <p class="subj">${result.bdTitle }<c:if test="${result.newYn eq 'Y' }"><img src="/resource/templete/cms1/src/img/common/icon_new.png" alt="새 글" style="margin-left: 10px;width: 20px;"/></c:if></p>
			              <div class="infor">
		           		...
		           		<span class="btn-more"><img src="${ctx}/resource/templete/cms1/src/img/sub/btn_more.png" alt="더보기"></span>
		           	</span>
		         </a>
	         </li>
         </c:forEach>
