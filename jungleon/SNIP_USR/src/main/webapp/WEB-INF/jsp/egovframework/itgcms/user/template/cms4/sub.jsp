			...
			<div class="sub_navi_menu">
				...
				<c:if test="${menuVO.menuSnsShareyn eq 'Y' }">
					<div class="menu__set-sns">
						<button href="#" class="menu__set-sns_open" title="sns공유하기 팝업창열기">
							...
							<div class="menu__sns-group--inbox">
								<div class="sns_link_btn">
									...
									<ul>
										...
										<li><button class="menu__set-sns_close" title="sns공유하기 팝업창 닫기"><img src="${ctx }/resource/templete/${siteconfigVO.tempCode }/src/img/common/icon_share_close.jpg" alt="" /></button></li>
									</ul>
								</div>
                        ...
                        <form name="satisForm" id="satisForm" method="post">
                            ...
                            <div class="page-apraisal-tit">
                                ...
                                <c:if test="${menuVO.menuChargeuseyn eq 'Y' }" >
                                    ...
                                    <span class="tel">문의 :
                                    <c:choose>
                                    	<c:when test="${not empty menuVO.mngrManagerVO.mngPhone }">
	                                    	<c:out value="${menuVO.mngrManagerVO.mngPhone }" />
                                    	</c:when>
                                    	<c:when test="${not empty menuVO.mngrManagerVO.mngEmail }">
    	                                	<a href="mailto:<c:out value="${menuVO.mngrManagerVO.mngEmail }" />"><img src="${ctx}/resource/templete_common/img/common/appraisal_ic_mail.png" alt="메일보내기" class="ml5"></a>
                                    	</c:when>
                                    </c:choose>
                                    </span>
                                </c:if>
