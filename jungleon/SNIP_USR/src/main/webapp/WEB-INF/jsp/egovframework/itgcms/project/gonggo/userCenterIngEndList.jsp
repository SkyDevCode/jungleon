                ...
                <!-- 게시판리스트 -->
                        ...
                        <form name="listForm" method="post" onsubmit="fn_search(); return false;">
                            <fieldset>
                                ...
                                <div class="inner">
									...
									<c:set var="schSet" value="${ufn:deCode(searchVO.schOpt3,'9A60032DE24D478E90A6D93DC2D47D99,centerCode1,0D9BC5F72EE74AFF8464F74464C9E5CF,centerCode2,D31CAB4467494F7F9261632C822F7A05,centerCode3','')}"></c:set>
	                				<ora:selectCodeList selectName="schOpt3" selectedValue="${schSet }" codeList="${codeList }" selectTitle="구분" className="select_box"/>
                    ...
                    <div class="board-list_wrap">
                        <table class="board-list">
                             <caption>
						            <p class="ir-text">번호,센터명,제목,접수기간,첨부,담당자,작성일,조회수로 구성된 <c:out value="${boardconfigVO.bcName }" /> 게시판 리스트</p>
						        </caption>
                          ...
                          <tbody>
                          	<c:forEach var="result" items="${resultList}" varStatus="status">
								...
								<tr>
									...
									<td class="num">${ufn:deCode(result.snpbiz,'9A60032DE24D478E90A6D93DC2D47D99,제1비즈니스센터,0D9BC5F72EE74AFF8464F74464C9E5CF,킨스타워,D31CAB4467494F7F9261632C822F7A05,성남 메디바이오 캠퍼스','기타')}</td>
				    				<td class="subject">
...
//<[[!CDATA[
	...
	function fn_goView(id) {
		...
		location.href="https://www.snip.or.kr/SNIP/contents/Business31.do?" + tmpQuery;
	}
