						    ...
						    <ol class="caution-content">
						    	...
						    	<li>IP목록을 입력하실 때, 형식을 지키지 않으면 시스템에 문제가 발생할 수 있습니다.
						    		<ul>
						   				...
						   				<li>- IP 범위 예시 : 198.120.14.1-198.121.15.3 혹은 198.120 혹은 198.130.1</li>
						   				<li>- 조건 구분은 공백없이 ,(콤마)로 작성해야 합니다. (예시 : 198.120.14.1,198.120,198.120.14.1-198.121.15.3)</li>
						   			</ul>
						    	</li>
						    	<li>
						   			아래 표의 구분은 다음과 같습니다.
								...
								<form id="${result.siteCode}_form" name="${result.siteCode}_form">
									<tr id="${result.siteCode}_tr">
										...
										<td>
											...
											<textarea rows="2" class="form-control validate-ip" id="${result.siteCode}_newDesc" name="ipDesc" style="resize:none;">${result.ipDesc}</textarea>
