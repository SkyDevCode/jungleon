...
<%@ taglib prefix="ufn" uri="/WEB-INF/tlds/egovfn.tld"%>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
		                <div class="box-header with-border">
		                  	<h3 class="box-title">
		                  		...
		                  		${searchVO.schDateFrom} ${ufn:IIF(searchVO.schDateFrom eq searchVO.schDateEnd,'',endDateStr)}${titleStr} 자원봉사 통계
							</h3>
		                </div><!-- /.box-header -->
						<div class="box-body">
					...
					<div class="box">
						<div class="box-header with-border">
							<span><i class="fa fa-circle-o text-light-orange"></i> 기간 내 총 <i id="cnt"></i> 명 <c:if test="${searchVO.schOption ne 'STATUS' and searchVO.schOption ne 'SEX' }">(※상태 승인 기준 통계 입니다.)</c:if> </span>
