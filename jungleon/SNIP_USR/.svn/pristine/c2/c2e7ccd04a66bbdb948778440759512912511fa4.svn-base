...
<c:if test="${boardconfigVO.bcFileyn eq  'Y' }">
				...
				<th scope="col" class="n_mobile">상태</th>
			</tr>
		</thead>
		<tbody>
			<!-- 공지사항 출력 -->
...
<c:if test="${boardconfigVO.bcFileyn eq  'Y' }">
				...
				<td class="n_mobile"><strong>&nbsp;</strong></td>
			</tr>
			</c:forEach>
			<!-- 공지사항 출력 end -->
...
<c:if test="${boardconfigVO.bcGroupyn eq  'Y' }">
				...
				<td class="subj">
					...
					<span class="v_mobile status">
						<c:choose>
			            	<c:when test="${empty result.bdAnswer }"><span class="reply">답변 대기</span></c:when>
			                <c:otherwise><span class="reply finish">답변 완료</span></c:otherwise>
		                </c:choose>
		            </span>
...
<c:if test="${boardconfigVO.bcFileyn eq  'Y' }">
		        ...
		        <td class="n_mobile">
		                  <c:choose>
			                  <c:when test="${empty result.bdAnswer }">
									<span class="reply">답변 대기</span>
			                  </c:when>
			                  <c:otherwise>
									<span class="reply finish">답변 완료</span>
			                  </c:otherwise>
			                </c:choose>
		        </td>
			</tr>
