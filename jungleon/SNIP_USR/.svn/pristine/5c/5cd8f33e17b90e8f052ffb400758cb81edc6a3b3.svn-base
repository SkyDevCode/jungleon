...
<!-- board-list -->
<div class="board-list_wrap list-type_2">
    <table class="board-list">
        <caption>
        <c:choose>
        	<c:when test="${boardConfigVO.bcId == 'notice221'}">
        		<p class="ir-text">번호,분류,제목,첨부,담당자,작성일,조회수로 구성된 <c:out value="${boardconfigVO.bcName }" /> 게시판 리스트</p>
        	</c:when>
        	<c:otherwise>
            ...
            <colgroup class="n_mobile">
				...
				<c:if test="${boardconfigVO.bcFileyn eq  'Y' }">
                	...
                	<col class="col4" width="5%">
				</c:if>
                <col class="col5" width="20%">
                <col class="col6" width="15%">
                <col class="col7" width="10%">
            </colgroup>
        <thead>
         <tr>
             	<th scope="col">번호</th>
