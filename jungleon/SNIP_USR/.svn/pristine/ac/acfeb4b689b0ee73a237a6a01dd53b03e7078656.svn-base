		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form name="managerForm" id="managerForm" method="post" action="">
					...
					<input type="hidden" name="hasAuth" />
...
//<![CDATA[
	...
	function fn_searManagerMore(){ //더보기용 페이지 증가
		searchManagerPage++;
		fn_searchManager(searchManagerPage, document.managerForm.hasAuth.value);
	}
	...
	function fn_searchManager(page,hasAuth){//검색결과 조회
		...
		if(hasAuth){
			dataStr +="&schOpt2="+hasAuth;
			document.managerForm.hasAuth.value = hasAuth;
		};
