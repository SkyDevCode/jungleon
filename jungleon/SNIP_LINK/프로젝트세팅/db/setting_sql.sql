...
-- 프로그램 코드
-- 일반회원관리
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('membercd', '일반회원관리', 'programcd', '2', '6', '00', '', '', 'itgood', NULL, NULL, 'y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('memstatuscd', '회원상태코드', 'membercd', '2', '3', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('mem_cutoff', '차단', 'memstatuscd', '3', '2', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('mem_del', '탈퇴', 'memstatuscd', '3', '3', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('mem_normal', '승인', 'memstatuscd', '3', '1', '00', '', '', 'itgood', 'itgood', NULL, 'Y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('mem_unreceived', '미승인', 'memstatuscd', '3', '5', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code (c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('mem_wait', '대기', 'memstatuscd', '3', '4', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');

/**
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('career1', '경력직종코드', 'membercd', '3', '4', '00', '', '', 'itgood', NULL, NULL, 'N', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('ET', '기타', 'career1', '4', '5', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('OJ', '사무직', 'career1', '4', '4', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('PE', '생산직', 'career1', '4', '2', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('RS', '연구직', 'career1', '4', '1', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('SM', '영업직', 'career1', '4', '3', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');

INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('career2', '경력코드', 'membercd', '3', '5', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('Y1', '1~3년', 'career2', '4', '1', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('Y2', '4~6년', 'career2', '4', '2', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('Y3', '7~10년', 'career2', '4', '3', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
INSERT INTO t_code(c_code,c_name,c_pcode,c_depth,c_order,c_auth,etc1,etc2,regmemid,updmemid,delmemid,defaultyn,delyn)
VALUES ('Y4', '10년 이상', 'career2', '4', '4', '00', '', '', 'itgood', NULL, NULL, 'Y', 'N');
**/
...
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('로그인','/login/login.do','/_mngr_/loginconfig/loginConfig_view.do');
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('로그아웃','/login/logout.do','-');
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('회원가입','/member/memberRegist.do','/_mngr_/joinformconfig/joinFormConf_view.do');
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('통합검색','/program/combineSearch.do','-');
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('소셜미디어','socialhub','view_snsConfig');
insert into t_program (prog_name, prog_userurl, prog_mngrurl) values ('약관정책','/program/contract.do','/_mngr_/module/contract_view.do');
...
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('policyPersonal','개인정보처리방침',	'2','7'	,'/program/contract.do'	,'/_mngr_/module/contract_view.do',3,'common'	,1,	'>CUBECMS>공통프로그램>개인정보처리방침', '>web>common>policyPersonal', 'itgood','001001','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('policyTerms',	'이용 약관',		'2','7'	,'/program/contract.do'	,'/_mngr_/module/contract_view.do',3,'common'	,2,	'CUBECMS>공통프로그램>이용 약관', '>web>common>policyTerms', 'itgood','001002','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webMemReg',	'회원가입',		'2','4'	,'/member/memberRegist.do',	'/_mngr_/joinformconfig/joinFormConf_view.do',3,'common'	,3,	'>CUBECMS>공통프로그램>회원가입', '>web>common>webMemReg', 'itgood','001003','web');
insert into t_menu(menu_code,menu_name,menu_type,menu_subType,menu_url,menu_navi,menu_depth,menu_pcode,menu_order,menu_memo,menu_useyn,menu_showtype,menu_mngurl,menu_chargeuseyn,mng_id,menu_lnbuseyn,menu_researchuseyn,menu_pfullname,menu_pfullcode,menu_usetype,menu_qruseyn,menu_contents,regmemid,updmemid,delyn,menu_fullorder,menu_mainpage,menu_snsshareyn,menu_sitecode)
			values ('webMyInfo','회원정보수정','1','','','',3,'webMyPage',1,'','Y','0','','N','','Y','N','>CUBECMS>마이페이지>회원정보수정', '>web>webMyPage>webMyInfo','0','N','','itgood',null,'N','009001',0,'N','web');
insert into t_menu(menu_code,menu_name,menu_type,menu_subType,menu_url,menu_navi,menu_depth,menu_pcode,menu_order,menu_memo,menu_useyn,menu_showtype,menu_mngurl,menu_chargeuseyn,mng_id,menu_lnbuseyn,menu_researchuseyn,menu_pfullname,menu_pfullcode,menu_usetype,menu_qruseyn,menu_contents,regmemid,updmemid,delyn,menu_fullorder,menu_mainpage,menu_snsshareyn,menu_sitecode)
			values ('webMyPage','마이페이지','0','','','',2,'web',7,'','Y','0','','N','','Y','N','>CUBECMS>마이페이지', '>web>webMyPage','1','N','','itgood',null,'N','009',0,'N','web');

insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webLogin',		'로그인',		'2','2'	,'/login/login.do'	,'/_mngr_/loginconfig/loginConfig_view.do',3,'common'	,4,	'>CUBECMS>공통프로그램>로그인', '>web>common>webLogin', 'itgood','001004','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webLogout',	'로그아웃',		'2','3'	,'/login/logout.do'	,'-',3,'common'	,5,	'>CUBECMS>공통프로그램>로그아웃', '>web>common>webLogout', 'itgood','001005','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webSitemap',	'사이트맵',		'2','1'	,'/main/sitemap.do'	,'-',3,'common'	,6,	'>CUBECMS>공통프로그램>사이트맵', '>web>common>webSitemap', 'itgood','001006','web');

insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('search','통합검색',		'0',''	,				''		,2,'web',	2,	'>CUBECMS>통합검색', '>web>search', 'itgood','001','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webSearch',	'통합검색',		'2','5'	,'/program/combineSearch.do'	,'-',3,'search'	,1,	'>CUBECMS>통합검색>통합검색', '>web>search>webSearch', 'itgood','002001','web');

insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('social',	'소셜미디어',		'0',''	,				''	,2,'web',	3,	'>CUBECMS>소셜미디어', '>web>social', 'itgood','001','web');
insert into t_menu (menu_code,menu_name,menu_type,menu_subType,menu_url,menu_mngurl,menu_depth,menu_pcode,menu_order,menu_pfullname,menu_pfullcode,regmemid,menu_fullorder,menu_sitecode)
			values ('webSocial',	'소셜미디어',		'2','6'	,'socialhub'	,'view_snsConfig',3,'social'	,1,	'>CUBECMS>소셜미디어>소셜미디어', '>web>social>webSocial', 'itgood','003001','web');
