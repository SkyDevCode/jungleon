...
public class MyQnaVO {
	...
	public String getQstSummary() {
		return qstSummary;
	}
	public void setQstSummary(String qstSummary) {
		this.qstSummary = qstSummary;
	}
	...
	public void setIpinId(String ipinId) {
		this.ipinId = ipinId;
	}
