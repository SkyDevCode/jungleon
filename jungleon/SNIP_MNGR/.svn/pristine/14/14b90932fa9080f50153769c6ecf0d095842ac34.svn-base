...
$(document).ready(function(){
	...
	ItgJs.fn_datePickerRange("#bdExt5", "#bdExt6");
										...
										<c:if test="${boardconfigVO.bcGroupyn eq 'Y' }">
											<tr>
												...
												<td colspan="3" class="last">
													<ora:selectCodeList selectName="bdCode" selectedValue="${boardMap.bdCode }" codeList="${codeList}" selectTitle="센터명"/>
												</td>
											</tr>
										</c:if>
										<tr>
											<th class="t"><label for="bdExt2">담당부서</label></th>
											<td>
												<input type="text" name="bdExt2" id="bdExt2" class="form-control input-sm f-wd-600" value="<c:out value="${boardMap.bdExt2 }"/>" maxlength="50" title="담당부서" />
											</td>
											<th class="t"><label for="bdExt3">담당자</label></th>
											<td>
												<input type="text" name="bdExt3" id="bdExt3" class="form-control input-sm f-wd-600" value="<c:out value="${boardMap.bdExt3 }"/>" maxlength="50" title="담당자" />
											</td>
										</tr>
										<tr>
												<th class="t" colspan="1"><label for="bdExt4">연락처</label></th>
												<td colspan="3">
													<input type="text" name="bdExt4" id="bdExt4" maxlength="13" value="<c:out value="${boardMap.bdExt4 }"/>" class="form-control input-sm f-wd-200 validate-tel-num" onkeydown="return ItgJs.fn_phone(event);" title="연락처" />
												</td>
											</tr>
										<tr>
											...
											<td colspan="3">
												<div class="form-inline">
													<input type="text" name="bdExt5" id="bdExt5" maxlength="10" title="접수 시작일" value="<c:out value="${boardMap.bdExt5 }" />" class="required form-control input-sm f-wd-100" readonly="readonly" />
					                                    &nbsp;&nbsp;~&nbsp;&nbsp;
													<input type="text" name="bdExt6" id="bdExt6" maxlength="10" title="접수 종료일" value="<c:out value="${boardMap.bdExt6}" />" class="required form-control input-sm f-wd-100" readonly="readonly"  />
												</div>
											</td>
										</tr>
										<tr>
