							...
							<div class="col-xs-12 table-responsive">
								<table class="table table-bordered tp2">
									...
									<tbody>
										...
										<tr>
											<th class="t"><label for="cgDept">담당부서</label></th>
											<td>
												<input type="text" name="cgDept" id="cgDept" class="form-control input-sm f-wd-600" value="<c:out value="${boardMap.cgDept }"/>" maxlength="50" title="담당부서" />
											</td>
										...
										<tr>
											<th class="t" colspan="1"><label for="cttPc">연락처</label></th>
											<td colspan="3">
												<input type="text" name="cttPc" id="cttPc" maxlength="13" value="<c:out value="${boardMap.cttPc }"/>" class="form-control input-sm f-wd-200 validate-tel-num" onkeydown="return ItgJs.fn_phone(event);" title="연락처" />
											</td>
										</tr>
										<c:choose>
				                         	...
				                         	<c:otherwise>
				                         		<tr>
													<th class="t"><label for="bdUseyn">접수기간</label></th>
													<%-- <td colspan="3">
														<div class="form-inline">
															<input type="text" name="recSdt" id="recSdt" maxlength="10" title="접수 시작일" value="<c:out value="${boardMap.recSdt }" />" class="required form-control input-sm f-wd-100" readonly="readonly" />
							                                    &nbsp;&nbsp;~&nbsp;&nbsp;
															<input type="text" name="recEdt" id="recEdt" maxlength="10" title="접수 종료일" value="<c:out value="${boardMap.recEdt}" />" class="required form-control input-sm f-wd-100" readonly="readonly"  />
														</div>
													</td>
													<fmt:parseDate var="startDateFmt" pattern="yyyy-MM-dd" value="${boardMap.bdAnnouncementStartDate}"/>
		                                			<fmt:formatDate pattern="yyyy-MM-dd" value="${startDateFmt}"/>
		                                			<td>
														<fmt:parseDate var="startDateFmt" pattern="yyyy-MM-dd" value="${boardMap.biddingPublicStartDate}"/>
														<input type="text" name="biddingPublicStartDate" id="biddingPublicStartDate" class="required form-control input-sm f-wd-600" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${startDateFmt}"/>" maxlength="50" title="접수 시작일"/>
													</td> --%>
		                                			<td colspan="3">
														<div class="form-inline">
															<fmt:parseDate var="recSdt" pattern="yyyy-MM-dd" value="${boardMap.recSdt}"/>
															<input type="text" name="recSdt" id="recSdt" maxlength="10" title="접수 시작일" value="<fmt:formatDate pattern='yyyy-MM-dd' value="${recSdt}"/>" class="required form-control input-sm f-wd-100" readonly="readonly" />
							                                    &nbsp;&nbsp;~&nbsp;&nbsp;
							                                 <fmt:parseDate var="recEdt" pattern="yyyy-MM-dd" value="${boardMap.recEdt}"/>
															<input type="text" name="recEdt" id="recEdt" maxlength="10" title="접수 종료일" value="<fmt:formatDate pattern='yyyy-MM-dd' value="${recEdt}"/>" class="required form-control input-sm f-wd-100" readonly="readonly"  />
														</div>
													</td>
												</tr>
				                         	</c:otherwise>
