...
%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box">
						<div class="box-header with-border">
							<span><i class="fa fa-circle-o text-light-orange"></i> 기간 내 공유건수 총 <i id="cnt"></i> 명</span>
										    ...
										    <table id="example1" class="table table-bordered">
										        ...
										        <thead>
													<tr>
														...
														<th scope="col">메뉴명</th>
														<th scope="col">위치</th>
														<th scope="col">공유건수</th>
														<th scope="col">누적<br/>공유건수</th>
													</tr>
												</thead>
										        <tbody>
										        	...
										        	<c:forEach var="result" items="${resultList}" varStatus="status">
										        		...
										        		<tr>
															...
															<td><a href="/${result.siteCode}/contents/${result.cntName}.do" target="_blank"><c:out value="${result.menuName}" /></a></td>
															<td><c:out value="${result.menuFullName}" /></td>
...
//<![CDATA[
	...
	<c:forEach var="result" items="${resultList}" varStatus="status">
		...
		chartData.push({"label" : "<c:out value='${result.menuName == "" ? result.cntName : result.menuName}'/>", "value" : "${result.cntCount}"});
	</c:forEach>
	...
	/* var chartData = [{'label':'회사소개', 'value':45}, {'label':'공공', 'value':67}, {'label':'수출바우처사업', 'value':27}, {'label':'오시는길', 'value':77}];
