				...
				<div class="row margin-bottom">
					<div class="col-sm-8 form-inline">
						...
						<c:if test="${boardconfigVO.bcGroupyn eq  'Y' }">
							...
							<ora:selectCodeList selectName="schBdcode" selectedValue="${searchVO.schBdcode }" codeList="${codeList }" selectTitle="사업명" className="form-control input-sm"/>
						</c:if>
							...
							<tbody>
								...
								<c:forEach var="result" items="${resultList}" varStatus="status">
									...
									<tr>
										...
										<td class="tac bg_title" style="padding-left: ${lpadding}px;"><a href="#none" onclick="fn_goView('<c:out value="${result.bdIdx }" />')"><c:out value="${urlInfo.menuName}" /></a></td>
										<c:if test="${boardconfigVO.bcFileyn eq  'Y' }">
											<td class="tac">
