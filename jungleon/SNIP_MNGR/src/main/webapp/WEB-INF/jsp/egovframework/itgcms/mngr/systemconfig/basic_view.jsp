						...
						<table id="systemConfig" class="table table-bordered tp2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<label style="margin-right:20px"><input class="minimal required" type="radio" name="mngrMultilogin" value="Y" ${ufn:checked(systemconfigVO.mngrMultilogin, 'Y')}/>허용</label>
										<label style="margin-right:20px"><input class="minimal required" type="radio" name="mngrMultilogin" value="N" ${ufn:checked(systemconfigVO.mngrMultilogin, 'N')}/>방지</label>
									</td>
								</tr>
