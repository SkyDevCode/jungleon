...
<%
/**
 * @파일명 : _mngr__bsnsPblanc_view.jsp
 * @파일정보 : 관리자 사업공고 게시판 조회 스킨
 * @수정이력
 * @수정자 수정일 수정내용
 * @------- ------------ ----------------
 * @hsk1218 2020. 03. 17. 최초생성
 * @---------------------------------------
 * @author (주)아이티굿 개발팀
 * @since 2009. 01.14
								...
								<table class="table table-bordered tp2">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="bsName" id="bsName" class="required form-control input-sm f-wd-600" value="<c:out value="${boardMap.bsName }"/>" maxlength="50" title="사업명" />
											</td>
										</tr>
										<tr>
