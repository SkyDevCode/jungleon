							...
							<div class="row">
								<div class="col-xs-12 table-responsive">
									<table class="table table-bordered tp2">
										...
										<tr>
											<th class="t"><label for="areaCd">주소 *</label></th>
											<td>
												<select name="areaCd" id="areaCd" class="form-control required">
													<c:forEach var="code" items="${addr }">	
														<option value="${code.ccode }" ${ufn:selected(result.areaCd, code.ccode) }><c:out value="${code.cname}" /></option>
													</c:forEach>
												</select>
											</td>
