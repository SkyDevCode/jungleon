						...
						<table class="table table-bordered tp2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
	                                	...
	                                	<c:if test="${not empty result.slitemImg }">
	                                    	...
	                                    	<br />
	                                    	<img class="transbg" src="<c:url value="/comm/download.do?f=${ufn:getDownloadLink('','slides',result.slitemImg,result.slitemImg) }" />" alt="<c:out value="${result.slitemImgalt}" />" style="max-width:600px;max-height:400px;"/>
	                                  	</c:if>
									</td>
								</tr>
								<tr>
								...
								<tr class="forLinkgubun2">
									...
									<td>
	                                	...
	                                	<c:if test="${not empty result.slitemLinktimg }">
	                                    	...
	                                    	<br />
	                                    	<img class="transbg" src="<c:url value="/comm/download.do?f=${ufn:getDownloadLink('','slides',result.slitemLinktimg,result.slitemLinktimg) }" />" alt="<c:out value="${result.slitemLinkttxt}" />" style="max-width:600px;max-height:400px;"/>
	                                  	</c:if>
									</td>
								</tr>
								<tr class="forLinkgubun2">
								...
								<tr class="forLinkgubun2">
									...
									<td>
	                                	...
	                                	<c:if test="${not empty result.slitemLinksimg }">
	                                    	...
	                                    	<br />
	                                    	<img class="transbg" src="<c:url value="/comm/download.do?f=${ufn:getDownloadLink('','slides',result.slitemLinksimg,result.slitemLinksimg) }" />" alt="<c:out value="${result.slitemLinkstxt}" />" style="max-width:600px;max-height:400px;"/>
	                                  	</c:if>
									</td>
								</tr>
								<tr class="forLinkgubun2">
								...
								<tr class="forLinkgubun1 forLinkgubun2">
									...
									<td>
										<input type="text" name="slitemLinkurl" id="slitemLinkurl" title="링크주소" value="<c:out value="${result.slitemLinkurl}"/>" class="form-control input-sm f-wd-400 forLinkgubun1 forLinkgubun2" /><p></p>
