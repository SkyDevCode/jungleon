...
<%
/**
 * @파일명 : _mngr__gallery_view.jsp
 * @파일정보 : 관리자 갤러리형 게시판 조회 스킨
 * @수정이력
 * @수정자 수정일 수정내용
 * @------- ------------ ----------------
								...
								<table class="table table-bordered tp2">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="charger" id="charger" class="form-control input-sm f-wd-600" value="<c:out value="${boardMap.charger }" />" maxlength="50" title="담당자" />
											</td>
										</tr>
