				...
				<tbody>
					...
					<tr>
						...
						<c:choose>
							...
							<c:otherwise>
								<input type="text" name="menuName" id="menuName" maxlength="100" class="required form-control input-sm f-wd-200" title="메뉴이름" value="<c:out value="${result.menuName }" />" />
							</c:otherwise>
						</c:choose>
						</td>
					</tr>
					<tr>
						...
						<td><textarea name="menuMemo" id="menuMemo" maxlength="150" class="form-control" title="메뉴설명" ><c:out value="${result.menuMemo }" /></textarea></td>
					</tr>
					<tr>
...
<%-- 					<tr class="htmlEditor">
					...
					<tr>
						<th class="t"><label for="menuUsetype1">메뉴 사용타입</label></th>
						<td>
						    <label><input type="radio" name="menuUsetype" id="menuUsetype1" class="required" title="사용자(메뉴 노출)" value="0" ${ufn:checked(result.menuUsetype, '0')} ${ufn:checked(result.menuUsetype, '')} />사용자(메뉴 노출)</label>
                            <label style="margin-left:20px;"><input type="radio" name="menuUsetype" id="menuUsetype2" class="required" title="사용자(메뉴 숨김)" value="1" ${ufn:checked(result.menuUsetype, '1')} />사용자(메뉴 숨김)</label>
                            <label style="margin-left:20px;"><input type="radio" name="menuUsetype" id="menuUsetype3" class="required" title="관리자" value="2" ${ufn:checked(result.menuUsetype, '2')} />관리자</label>
				        	<span class="help-block" style="margin: 0;">사용자/관리자 선택, 사용자메뉴의 GNB 메뉴 표시 여부 선택</span>
						</td>
					</tr>
					<tr>
						<th class="t"><label for="menuUsetype1">페이지타입</label></th>
						<td>
					...
					<tr>
						<th class="t"><label for="menuUseyn">사용여부</label></th>
						<td>
