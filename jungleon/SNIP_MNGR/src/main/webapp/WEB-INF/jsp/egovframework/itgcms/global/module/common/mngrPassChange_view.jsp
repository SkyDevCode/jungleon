		...
		<div class="box">
			<div class="box-body">
				<div class="col-md-12" style="padding:0;">
					<form name="passChangeConfig" id="passChangeConfig" method="post" onsubmit="fn_egov_save(); return false;" class="form-horizontal">
						<table class="table table-bordered table tp2">
							...
							<tr>
								<th style="vertical-align: middle;"><span>비밀번호 변경 메뉴코드</span></th>
								<td>
									<label>${passChangeMenuCode}</label>
								</td>
							</tr>
						</table>
...
function fn_egov_save() {
	frm = document.passChangeConfig;
	if(Validator.validate(frm)){
		$.ajax({
			url : '${urlInfo.menuCode}_edit_mngrPassChange_proc.ajax',
			data : $("#passChangeConfig").serialize(),
			type : "POST",
