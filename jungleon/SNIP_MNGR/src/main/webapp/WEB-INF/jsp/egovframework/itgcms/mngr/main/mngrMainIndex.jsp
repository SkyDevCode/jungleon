          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3><fmt:formatNumber value="${memberRegistCount }" type="number" /></h3>
                  <p>신규 회원</p>
                </div>
                <div class="icon">
                ...
                <!-- 일반회원관리 로 연결 -->
                <a href="/_mngr_/member/member_list.do" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
