		...
		<div class="box">
			<div class="box-body">
				<div class="col-md-12" style="padding:0;">
					<form name="sitemapConfig" id="sitemapConfig" method="post" onsubmit="fn_egov_save(); return false;" class="form-horizontal">
						<table class="table table-bordered table tp2">
							...
							<tr>
								<th style="vertical-align: middle;"><span>사이트맵메뉴코드</span></th>
								<td>
									<label>${sitemapMenuCode}</label>
								</td>
							</tr>
						</table>
...
function fn_egov_save() {
	frm = document.sitemapConfig;
	if(Validator.validate(frm)){
		$.ajax({
			url : '${urlInfo.menuCode}_edit_mngrSitemap_proc.ajax',
			data : $("#sitemapConfig").serialize(),
			type : "POST",
