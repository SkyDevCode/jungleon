...
//<![CDATA[
	...
	var countBarChart = fn_barChart(countList, 'count-chart', 'y', ['countList'], ['게시글 수'], ${max_CountList});
	var readBarChart = fn_barChart(readNumList, 'read-chart', 'y', ['sumReadNum'], ['조회 수'], ${max_SumReadNum});
