						...
						<table class="table table-bordered table tp2">
							<colgroup>
								...
								<tr>
									...
									<td>
										<label><input class="from-control" type="number" name="sessionTime" max="600" min="300" style="width: 100px; text-align: right;" value="${sessionTime}"/>&nbsp;&nbsp;초</label>
										<span class="help-block" style="margin:5px 0 0;">서버 안전성 및 보안을 위하여 로그인 유효시간은 최소 300~600초만 가능합니다.</span>
									</td>
								</tr>
								<tr>
